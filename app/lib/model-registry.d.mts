...
export type ConnectionStatus = ChatModel["connectionStatus"];
...
export function reconcileModelCredentialRevisions(
  models: unknown,
  credentialRevisions: Readonly<Record<string, string>>,
): ChatModel[];
